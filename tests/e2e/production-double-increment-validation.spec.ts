...
test.describe('Production Double-Increment Bug Fix Validation', () => {
  ...
  test('CRITICAL: Usage counter increments correctly 1→2→3 (not double-increment)', async ({
    page,
  }) => {
  ...
  test('Email verification flow validation: signup → check-email → auto-redirect', async ({
    page,
  }) => {
