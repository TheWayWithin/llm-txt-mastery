...
test.describe('Smart Reset Flow - Core Functionality', () => {
  ...
  test('should preserve user context when clicking "Analyze Another Website" from content review', async ({
    page,
  }) => {
  ...
  test('should preserve user context when clicking "Analyze Another Website" from file generation', async ({
    page,
  }) => {
  ...
  test('should maintain consistent state across browser refresh after smart reset', async ({
    page,
  }) => {
  ...
  test('should handle edge case: multiple rapid clicks on "Analyze Another Website"', async ({
    page,
  }) => {
...
test.describe('Smart Reset Flow - State Machine Validation', () => {
  ...
  test('should validate START_NEW_ANALYSIS event preserves user data while clearing analysis data', async ({
    page,
  }) => {
  ...
  test('should differentiate between RESET_WORKFLOW and START_NEW_ANALYSIS events', async ({
    page,
  }) => {
