...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "As AI systems consume more web content, getting proper attribution isn't just about traffic—it's about survival in the post-LLM world.",
  ...
  },
  {
    ...
    excerpt: "Understanding the technical details of llms.txt and how to implement it effectively for maximum AI visibility.",
        ...
        <Card className="mb-8 bg-blue-50 border-blue-200">
          <CardContent className="p-6">
            <p className="text-center text-gray-700">
              <strong>Coming Soon:</strong> Real insights from building AI tools and helping websites survive the LLM revolution. 
              No corporate fluff, just practical wisdom from the trenches.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-8">
            <div className="text-center">
              ...
              <h2 className="text-2xl font-bold mb-4">
                Get Updates When New Posts Drop
              </h2>
              <p className="mb-6">
                No spam, no corporate newsletter BS. Just real insights when I have something worth sharing.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <Card className="text-center p-4">
              ...
              <p className="text-sm text-gray-600">
                How to thrive when AI is eating the web
              </p>
            </Card>
            <Card className="text-center p-4">
              <h3 className="font-semibold mb-2">Technical Deep Dives</h3>
              <p className="text-sm text-gray-600">
                The nitty-gritty of building AI tools
              </p>
            </Card>
            <Card className="text-center p-4">
              <h3 className="font-semibold mb-2">Solopreneur Life</h3>
              <p className="text-sm text-gray-600">
                Escaping corporate to build what matters
              </p>
            </Card>
          </div>
        </div>
