  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-ai-silver mb-4">
                  ...
                  We respect your choices and only use cookies as you permit.
                </p>
        ...
        <Card className="mb-6">
          <CardContent className="p-6 prose prose-slate max-w-none">
            ...
            <p className="text-ai-silver">
              ...
              to enhance your experience on our website. This Cookie Policy explains what cookies are, 
            ...
            <p className="text-ai-silver">
              ...
              You can manage your preferences at any time using the cookie management tool above.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
              ...
              <ul className="space-y-2 text-sm text-ai-silver">
                ...
                <li className="flex items-start">
                  <span className="text-innovation-teal mr-2">•</span>
                  <span><strong>Persistent Cookies:</strong> Remain on your device for a set period</span>
                </li>
                <li className="flex items-start">
                  <span className="text-innovation-teal mr-2">•</span>
                  <span><strong>Local Storage:</strong> Browser storage for user preferences and session data</span>
                </li>
                <li className="flex items-start">
                  <span className="text-innovation-teal mr-2">•</span>
                  <span><strong>Session Storage:</strong> Temporary browser storage cleared when tab closes</span>
                </li>
              </ul>
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <div className="bg-slate-50 rounded p-3 text-xs">
                  ...
                  <ul className="space-y-1 text-ai-silver">
                    <li>• <code>auth_access_token</code> - User authentication</li>
                    <li>• <code>auth_refresh_token</code> - Session management</li>
                    <li>• <code>gdpr_consent</code> - Cookie consent preferences</li>
                    <li>• <code>stripe_session</code> - Payment processing security</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <div className="bg-slate-50 rounded p-3 text-xs">
                  ...
                  <ul className="space-y-1 text-ai-silver">
                    <li>• <strong>Google Analytics 4:</strong> Website usage statistics</li>
              ...
              <div className="border-l-4 border-orange-500 pl-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs bg-orange-100 text-orange-800 px-2 py-1 rounded">Currently Disabled</span>
                </div>
                <p className="text-sm text-ai-silver mb-2">
                  Used to track visitors across websites for advertising purposes. We do not currently use marketing cookies.
                </p>
                <div className="bg-slate-50 rounded p-3 text-xs">
                  <p className="text-ai-silver italic">
                    We prioritize your privacy and do not engage in retargeting or advertising tracking.
                  </p>
                </div>
              </div>
            </div>
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <h2 className="text-xl font-semibold text-framework-black mb-4">Third-Party Services</h2>
            <p className="text-ai-silver mb-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3 p-3 bg-slate-50 rounded">
                ...
                <div className="flex-1">
                  ...
                  <a href="https://www.enzuzo.com/privacy" target="_blank" rel="noopener noreferrer" 
                     className="text-xs text-blue-600 hover:underline">
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <h2 className="text-xl font-semibold text-framework-black mb-4">Your Rights & Choices</h2>
            
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <Info className="h-5 w-5 text-innovation-teal mt-0.5" />
                <div>
                  <h3 className="font-semibold text-framework-black mb-1">Accept or Reject Cookies</h3>
                  <p className="text-sm text-ai-silver">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-ai-silver">
                    ...
                    Note that some parts of our service may not function properly without cookies.
                  </p>
                </div>
              </div>
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <h2 className="text-xl font-semibold text-framework-black mb-4">How to Manage Cookies in Your Browser</h2>
            <p className="text-ai-silver mb-4">
        ...
        <Card className="mb-6">
          <CardContent className="p-6">
            <h2 className="text-xl font-semibold text-framework-black mb-4">Updates to This Policy</h2>
            <p className="text-ai-silver">
