          ...
          <CardContent className="p-8 prose prose-gray max-w-none">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                By using LLM.txt Mastery, you agree to these terms. If you don't agree, 
                please don't use the service. Simple as that.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>Free Tier:</strong> Get 3 analyses per day with AI-powered evaluation. 
                  No credit card required.
                </p>
                <p>
                  <strong>Paid Tiers:</strong> Various plans available for more analyses and features. 
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                I'm a solopreneur, not a megacorp with deep pockets. I'll do my best to provide 
                a reliable, useful service, but:
              </p>
              <ul className="space-y-2 text-gray-700 ml-6">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                for details on how we handle your data. Short version: We don't sell it, 
                share it unnecessarily, or use it for anything beyond providing the service.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                The service will evolve based on user feedback and technological advances. 
                I'll notify you of significant changes via email. If changes materially 
                affect your usage, you can cancel anytime.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                You can stop using the service anytime. If you violate these terms, 
                I may suspend or terminate your access. In either case, you can download 
                your generated files before account closure.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700">
                If we have a disagreement, let's try to work it out like adults. 
                Email me directly and we'll find a solution. No mandatory arbitration 
                clauses or legal gymnastics—just honest communication.
              </p>
            </div>
            ...
            <div className="bg-green-50 border-l-4 border-green-600 p-6">
              ...
              <p className="text-gray-700">
                These terms exist to protect both of us and ensure the service works well for everyone. 
                I'm not trying to trick you with legal jargon or hidden clauses. Just use the service 
                responsibly, and we'll get along great.
              </p>
              <p className="text-gray-700 mt-3">
                Thanks for choosing a tool built by a solopreneur over corporate alternatives. 
