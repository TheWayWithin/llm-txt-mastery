      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          >
            {/* Starter Tier */}
            <div
              className="relative border-2 border-red-300 rounded-lg bg-red-50 hover:bg-red-100 transition-colors p-4 cursor-pointer"
            ...
            {/* Growth Tier */}
            <div
              className="relative border rounded-lg hover:bg-slate-50 transition-colors p-4 cursor-pointer"
