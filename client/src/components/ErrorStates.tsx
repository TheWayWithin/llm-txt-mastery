...
const ERROR_CONFIGS = {
  '404': {
    ...
    defaultMessage: "Oops! The page you're looking for seems to have wandered off. Let's help you find what you need.",
    icon: AlertCircle,
  ...
  generic: {
    ...
    defaultMessage: "We're working to fix this issue. Please try again in a moment, or contact support if the problem persists.",
    icon: Bug,
        ...
        {type === 'generic' && (
          <div className="mt-6 pt-4 border-t border-purple-200">
            ...
            <Button 
              variant="outline" 
              size="sm"
              onClick={() => window.open('mailto:support@llmtxtmastery.com?subject=Error Report', '_blank')}
