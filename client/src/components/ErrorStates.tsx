  ...
  return (
    <Card className={`${config.bgColor} ${config.borderColor} ${className}`}>
      <CardContent className="text-center py-12 px-6">
        ...
        {/* Error Message */}
        <p className="text-slate-brand mb-6 max-w-md mx-auto">{message || config.defaultMessage}</p>
        ...
        {type === 'generic' && (
          <div className="mt-6 pt-4 border-t border-mist">
            <p className="text-sm text-slate-brand mb-3">Need immediate help?</p>
            <Button
              variant="outline"
              size="sm"
              onClick={() =>
              ...
              className="text-slate-brand border-mist hover:bg-cloud"
            >
              Contact Support
            </Button>
          </div>
