...
const SMART_DETECTION_PATTERNS = {
  ...
  MALICIOUS_USER_AGENTS:
    /^(wget|curl|python-requests|scrapy|selenium|phantomjs|bot|spider|crawler)$/i,
...
): Array<{ type: string; severity: ThreatLevel }> {
...
function calculateThreatLevel(
  violations: Array<{ type: string; severity: ThreatLevel }>
): ThreatLevel {
