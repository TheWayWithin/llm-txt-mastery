# Image Design Briefs - Option A Quick Wins
...
│ (grayed out)    │ (highlighted)   │
│                 │                 │
│ AI logos        │ AI logos        │
│ looking away    │ pointing toward │
│                 │                 │
│ "INVISIBLE      │ "DISCOVERED     │
│  TO AI"         │  BY AI"         │
└─────────────────┴─────────────────┘
...
- **Right Side (After)**:
  ...
  - Background: Bright, energetic green-teal gradient
  - Text: "DISCOVERED BY AI" in bright green text

- **Center Bridge**:
  - LLM.txt file icon connecting both sides
  - Small animation arrows showing the transformation
...
- **Alt text**: "Transformation from invisible to AI-discovered website with 73% more citations"
...
├─────────────────────────────────────────────────────────────┤
│ Other Generators:                                           │
│ Basic Scraping → 20 Pages → Generic Output                 │
│ [dull icons]      [small]    [basic file]                  │
├─────────────────────────────────────────────────────────────┤
│ LLM.txt Mastery:                                           │
│ AI Analysis → 200+ Pages → Optimized LLM.txt              │
│ [AI brain]    [large pile]  [premium file]                 │
└─────────────────────────────────────────────────────────────┘
```
...
- **Top Row (Competitors)**:
  ...
  - Step 3: Plain text file icon
  - Arrows: Simple gray arrows
  - Color theme: Muted grays and blues

- **Bottom Row (LLM.txt Mastery)**:
  - Step 1: AI brain icon with neural network pattern
  - Step 2: Large stack of pages with "200+" label and quality stars
  - Step 3: Premium file icon with checkmarks and optimization badges
  - Arrows: Bold teal arrows with energy effects
...
- **Alt text**: "Process comparison showing LLM.txt Mastery's AI analysis finds 200+ pages vs competitors' 20 pages"
