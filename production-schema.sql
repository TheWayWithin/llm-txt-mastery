...
ALTER TABLE "public"."analysis_cache" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."analysis_cache_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."cache_savings" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."cache_savings_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."cancellations" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."cancellations_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."emailCaptures" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."emailCaptures_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."llmTextFiles" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."llmTextFiles_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."one_time_credits" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."one_time_credits_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."refund_requests" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."refund_requests_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."simple_usage" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."simple_usage_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."sitemapAnalysis" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."sitemapAnalysis_id_seq" OWNER TO "neondb_owner";
...
ALTER TABLE "public"."usage_tracking" OWNER TO "neondb_owner";
...
ALTER SEQUENCE "public"."usage_tracking_id_seq" OWNER TO "neondb_owner";
