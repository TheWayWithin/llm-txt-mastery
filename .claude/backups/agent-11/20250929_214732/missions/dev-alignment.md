...
- @coordinator checks for available MCPs with grep "mcp\_\_"
- Identifies which MCPs are configured
- Maps MCPs to current architecture:
  - If Supabase used: Check for mcp\_\_supabase
  - If tests exist: Check for mcp\_\_playwright
  - For any libraries: Note mcp\_\_context7 availability
...
- mcp\_\_[service]: [Usage in project]
- Example: mcp\_\_supabase: Database operations
- Example: mcp\_\_playwright: E2E testing
- Example: mcp\_\_context7: Library documentation
...
_"Understanding before action, alignment before advancement."_ - AGENT-11 Field Manual
