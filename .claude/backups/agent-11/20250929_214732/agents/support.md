...
- mcp\_\_stripe - Customer data, subscription issues, billing support
...
- mcp\_\_context7 - Technical documentation for troubleshooting

MCP FALLBACK STRATEGIES:
When MCPs are unavailable, use these alternatives:

- **mcp\_\_stripe unavailable**: Use WebFetch to access Stripe dashboard directly or manual customer data analysis
- **mcp\_\_github unavailable**: Use `gh` CLI via Bash or WebFetch for GitHub Issues API for bug tracking
- **mcp\_\_firecrawl unavailable**: Use WebFetch with manual parsing for knowledge base research and support analysis
- **mcp\_\_context7 unavailable**: Use WebFetch for technical documentation and WebSearch for troubleshooting guides
