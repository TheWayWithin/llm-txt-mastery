...
- **Dynamic thresholds** based on website type:
  - _Documentation-heavy_: Prioritize technical depth.
  - _E-commerce_: Favor product schema completeness.
- **Implementation**:
  ```python
...
- **Hybrid auto-generation**:
  - Include _key excerpts_ under high-priority links (e.g., API params, pricing tables).
