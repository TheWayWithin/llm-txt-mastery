...
- **Visual Style**: Modern, Clean, Technical with subtle warmth
...
- **Innovation Teal**: `HSL(195, 100%, 39%)` | `#00A6C7` | RGB(0, 166, 199)
...
- **Growth Teal**: Same as Innovation Teal
  - Usage: Growth tier branding
- **Scale Blue**: Same as Mastery Blue
  - Usage: Scale tier branding
...
- **Usage**: App icon, favicon, loading states
...
- **Background**: Transparent where supported, white fallback
...
- **Theme**: Abstract visualization of AI analyzing website structure
- **Color Scheme**: Gradient from Innovation Teal to Mastery Blue
- **Elements**:
  - Stylized website wireframe transforming into structured data
  - Floating AI nodes/connections
  - Subtle animation potential (CSS ready)
...
- **Format**: SVG
- **Opacity**: 5-10% when used as background
- **Color**: Mastery Blue on white background
- **Pattern**: Subtle neural network connections
...
- **Concept**: Simple checkbox or starter rocket
...
- **Concept**: Steaming coffee cup with AI circuit patterns in steam
...
- **Concept**: Upward trending graph with data nodes
...
- **Concept**: Enterprise building or network globe
...
- **Concept**: Document with checkmark
...
- **Concept**: Friendly robot with tools, ready to fix
...
- **Dimensions**: 600x400px
- **Format**: PNG
- **Content**: Sample LLM.txt file preview
...
│   │   ├── pattern-neural-network.svg
│   │   └── empty-states/
│   │       ├── empty-no-analysis.svg
│   │       ├── empty-limit-reached.svg
│   │       └── empty-error.svg
│   ├── tiers/
│   │   ├── tier-free.svg
│   │   ├── tier-coffee.svg
...
│   │   └── tier-scale.svg
│   ├── process/
│   │   ├── process-url-input.svg
│   │   ├── process-analysis.svg
│   │   ├── process-review.svg
│   │   └── process-generation.svg
│   └── features/
...
Before delivery, ensure each asset meets these criteria:

- [ ] Correct dimensions and format
- [ ] Optimized file size
- [ ] Consistent with brand colors
- [ ] Works on both light and dark backgrounds (where applicable)
- [ ] Scalable without quality loss (SVGs)
- [ ] Follows naming convention exactly
- [ ] Includes source files (Figma/AI/Sketch)
