...
const componentChecks = [
  {
    ...
    checks: ['logo-primary.png', 'hero-illustration.png', 'how-it-works.png'],
  },
  {
    file: 'client/src/components/email-capture.tsx',
    checks: ['tier-free.png', 'tier-coffee.png', 'tier-growth.png', 'tier-scale.png'],
  },
  {
    file: 'client/src/components/ErrorStates.tsx',
    checks: ['error-404.png', 'error-connection.png', 'error-generic.png'],
  },
...
const passedTests =
  imageFiles.filter((f) => fs.existsSync(path.join(imagesDir, f))).length +
