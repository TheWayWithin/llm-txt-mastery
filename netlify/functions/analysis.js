    ...
    const mockPages = [
      {
        ...
        description:
          'Access hundreds of free online calculators for finance, math, health, and more',
      ...
      },
      {
        ...
        content:
          'FreeCalcHub was founded to provide free, accurate, and easy-to-use calculators for everyone. Our team of developers and mathematicians work to ensure all tools are reliable.',
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        avgQualityScore: Math.round(
          mockPages.reduce((sum, p) => sum + p.qualityScore, 0) / mockPages.length
        ),
